...
const FAQSection: React.FC = () => {
    ...
    "app-dev": [
      {
        ...
        answer: "We build native iOS and Android apps, cross-platform applications using React Native and Flutter, and progressive web apps (PWAs). Our apps range from consumer-facing mobile applications to enterprise-grade business tools."
      },
      {
  ...
  return (
    <FAQ
      ...
      faqData={faqData}
      className="bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white"
    />
  );
};
